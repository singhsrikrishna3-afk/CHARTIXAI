...
async def change_password(
    ...
    # We need to manually handle auth here since it's a special case
    from fastapi import Request
    # This endpoint uses the standard auth dependency
    raise HTTPException(
        status_code=501,
        detail="Use the /api/profile/change-password endpoint instead",
    )
